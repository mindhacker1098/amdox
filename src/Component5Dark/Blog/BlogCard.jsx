...
const BlogCard = ({
  ...
  return (
    <div className='group transition-all duration-500 rounded-lg bg-[#0b214a]'>
      ...
      <div className='rounded-b-lg relative z-20 flex justify-center transition-all duration-500 px-5 sm:px-7lg:px-5 2xl:px-[30px] pt-9 pb-6'>
        <div>
          ...
          <Link to={blogUrl}>
            <button className='font-FiraSans text-left font-semibold text-lg sm:text-xl lg:text-base xl:text-xl 2xl:text-[22px] text-white mt-2 mb-5'>
              {blogTitle}
            </button>
          </Link>
          <Link
