            ...
            >
              ...
              >
                <input
                  ...
                  required
                  className='w-full h-[56px] outline-none font-FiraSans border-b border-Secondarycolor-0 border-opacity-15 bg-transparent px-4 py-4 text-white placeholder:text-white mb-4'
                />
              </label>
